...
public interface UserbaseMapper {
    ...
    int setMobile(String no,long mobile);
     ...
     */
    @Insert({
        "insert into userbase (no, name, gender, ",
        "birth, mobile, ",
        "email, portrait, ",
    ...
    @ResultMap("cn.nevertiree.business.dao.UserbaseMapper.BaseResultMap")
    Userbase selectByPrimaryKey(String no);
